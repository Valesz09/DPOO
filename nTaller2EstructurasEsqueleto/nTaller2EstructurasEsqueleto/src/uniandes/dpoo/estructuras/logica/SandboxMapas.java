...
public class SandboxMapas
{
    ...
    {
    	 HashSet<String> valores = new HashSet<>(mapaCadenas.values());
         return valores.size();
    }
    ...
    {
    	String llaveEliminadaxd = null;
        for (Map.Entry<String, String> entry : mapaCadenas.entrySet()) {
            if (entry.getValue().equals(valor)) {
                llaveEliminadaxd = entry.getKey();
                break;
            }
        }
        if (llaveEliminadaxd != null) {
            mapaCadenas.remove(llaveEliminadaxd);
        }
    }
    ...
    {
    	Map<String, String> nuevoMapita = new java.util.HashMap<>();
        for (Map.Entry<String, String> entry : mapaCadenas.entrySet()) {
            nuevoMapita.put(entry.getKey().toUpperCase(), entry.getValue());
        }
        mapaCadenas = nuevoMapita;
    }
