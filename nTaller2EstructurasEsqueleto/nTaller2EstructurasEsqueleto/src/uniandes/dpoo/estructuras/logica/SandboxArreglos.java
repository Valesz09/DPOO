...
public class SandboxArreglos
{
    ...
    {
        arregloEnteros = java.util.Arrays.copyOf(arregloEnteros, arregloEnteros.length + 1);
    ...
    {
    	arregloCadenas = java.util.Arrays.copyOf(arregloCadenas, arregloCadenas.length + 1);
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        for (int repitis : histograma.values()) {
            if (repitis > 1) {
                contador++;
            }
        }
